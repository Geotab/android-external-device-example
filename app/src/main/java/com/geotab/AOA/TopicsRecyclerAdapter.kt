...
class TopicsRecyclerAdapter(
    private val dataSet: List<TopicsDataModel>, private val metrics: DisplayMetrics,
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.topicLayout.elevation =
            convertDipsToPixels(dataSet[position].subscribed.layoutElv)
    }
